...
def set_question_frame():
    ...
    lbl_ques=Label(frm,text="Question:",fg='blue',font=('Arial',20,'bold'),bg='green')
    lbl_ques.place(relx=.25,rely=.1)
    
    lbl_op1=Label(frm,text="Option-1:",fg='blue',font=('Arial',20,'bold'),bg='green')
    lbl_op1.place(relx=.25,rely=.2)
    
    lbl_op2=Label(frm,text="Option-2:",fg='blue',font=('Arial',20,'bold'),bg='green')
    lbl_op2.place(relx=.25,rely=.3)
    
    lbl_op3=Label(frm,text="Option-3:",fg='blue',font=('Arial',20,'bold'),bg='green')
    lbl_op3.place(relx=.25,rely=.4)
    
    lbl_op4=Label(frm,text="Option-4:",fg='blue',font=('Arial',20,'bold'),bg='green')
    lbl_op4.place(relx=.25,rely=.5)
    
    lbl_ans=Label(frm,text="Answer:",fg='blue',font=('Arial',20,'bold'),bg='green')
